...
namespace Nop.Plugin.Soft2Print.Seo
{
    ...
    public static class GenericPathRouteExtensions
    {
        ...
        public static IRouteBuilder MapGenericPathRoute1(this IRouteBuilder routeBuilder, string name, string template)
        {
            return MapGenericPathRoute1(routeBuilder, name, template, defaults: null);
        }
        ...
        /// <returns>Route builder</returns>
        public static IRouteBuilder MapGenericPathRoute1(this IRouteBuilder routeBuilder, string name, string template, object defaults)
        {
            return MapGenericPathRoute1(routeBuilder, name, template, defaults, constraints: null);
        }
        ...
        /// <returns>Route builder</returns>
        public static IRouteBuilder MapGenericPathRoute1(this IRouteBuilder routeBuilder,
            string name, string template, object defaults, object constraints)
        {
            return MapGenericPathRoute1(routeBuilder, name, template, defaults, constraints, dataTokens: null);
        }
