...
namespace Nop.Plugin.Soft2Print.Seo
{
    /// <summary>
    ...
    public class GenericPathRoute : LocalizedRoute
    {
        ...
        public override Task RouteAsync(RouteContext context)
        {
            ...
            if (!urlRecord.IsActive)
            {
                ...
                redirectionRouteData.Values["controller"] = Controllers.DefaultControllers.Commen;
            ...
            var slugForCurrentLanguage = urlRecordService.GetSeName(urlRecord.EntityId, urlRecord.EntityName, workContext.WorkingLanguage.Id);
            ...
            {
                case "product":
                    currentRouteData.Values["controller"] = Controllers.Soft2Print_Overwriter_ProductController.ControllerName;
                    ...
                    break;
                case "category":
                    currentRouteData.Values["controller"] = Controllers.DefaultControllers.Catalog;
                ...
                case "vendor":
                    ...
                    break;
                case "newsitem":
                    currentRouteData.Values["controller"] = Controllers.DefaultControllers.News;
                    currentRouteData.Values["action"] = "NewsItem";
                    currentRouteData.Values["newsItemId"] = urlRecord.EntityId;
                    currentRouteData.Values["SeName"] = urlRecord.Slug;
                    break;
                case "blogpost":
                    currentRouteData.Values["controller"] = Controllers.DefaultControllers.Blog;
                    currentRouteData.Values["action"] = "BlogPost";
                    currentRouteData.Values["blogPostId"] = urlRecord.EntityId;
                    currentRouteData.Values["SeName"] = urlRecord.Slug;
                    break;
                case "topic":
                    currentRouteData.Values["controller"] = Controllers.DefaultControllers.Topic;
