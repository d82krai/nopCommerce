...
{
    public class DALContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.ApplyConfiguration(new Entities.S2P_ProjectAttributes.Map());
            modelBuilder.ApplyConfiguration(new Entities.S2P_WebSession.Map());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(Entities.S2P_ProjectAttributes));
            this.DropPluginTable(nameof(Entities.S2P_ProjectAttributes));
        }
